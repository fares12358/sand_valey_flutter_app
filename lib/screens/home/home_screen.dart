  ...
  Future<Map<String, dynamic>> fetchMainCategories() async {
    try {
      final response = await http.get(
        Uri.parse("https://sand-valey-flutter-app-backend-node.vercel.app/api/auth/get-main-categories"),
      );
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Flexible(
                              child: customLayout(
                                image: mainCategories["seeds"]?["img"]?["url"] ?? "",
                                text: "بذور",
                                routeName: '/seed-main',
                              ),
                            ),
                          ...
                          children: [
                            Flexible(
                              child: customLayoutReversed(
                                image: mainCategories["Fertilizer"]?["img"]?["url"] ?? "",
                                text: "اسمده",
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Flexible(
                              child: customLayout(
                                image: mainCategories["Insecticide"]?["img"]?["url"] ?? "",
                                text: "مبيدات",
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Flexible(
                              child: customLayoutReversed(
                                image: mainCategories["Communication"]?["img"]?["url"] ?? "",
                                text: "تواصل معنا",
